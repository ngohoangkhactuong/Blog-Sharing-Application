...
const Navbar = () => {
    ...
    let regularClass =
        "px-3 py-2 border-1 border-orange-50 font-regular hover:text-[#c2272f] text-black rounded-md";

    let activeClass =
        "px-3 py-2 border-1 border-orange-50 font-regular text-black rounded-md border-b";
        ...
        <nav>
            <div
                className={
                    isHidden
                        ? "hidden"
                        : "backdrop-blur-xl fixed top-0 left-0 right-0 bg-white z-10 shadow-lg"
                }
            >
                    ...
                    <div className="flex items-center md:flex-row-reverse">
                        ...
                        <div className="block md:hidden">
                            <button
                                ...
                                className="bg-orange-500 text-black h-[30px] w-[30px] flex items-center justify-center rounded-full"
                            >
                                    ...
                                    <ul className="flex flex-col justify-start">
                                        {navItems.map((link) => (
                                            <li
                                                ...
                                                key={link.id}
                                                className="px-3 py-2 border-1 border-orange-50 font-semibold hover:text-[#c2272f] hover:bg-orange-400 w-100 mb-2 text-black"
                                            >
